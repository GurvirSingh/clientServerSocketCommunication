...
public class Client
{
    ...
    public Client(String address, int port)
    {
        try 
        {
            ...
            if(command.equals("1"))
            {
                System.out.println("Waiting for Server to Compute Operation");
           ...
           out.flush();
            ...
            System.out.println("Wating for Server to send Computation Result");
                ...
                if(N==P)
                {
                    ...
                    for(int i=0;i<M;i++)
                    {
                        ...
                        {                       
                            ...
                            //TempRes =TempRes +  input1.readUTF();

                        }
                        System.out.print("]");
                        System.out.println();
                    }
                    //System.out.println("String Result = " +TempRes);
                }
                else
                {
